...
# Whether to only include active caches.
ACTIVE_ONLY = False
...
# Go to
#     https://www.opencaching.de/search.php?searchto=searchall&showresult=1&expert=0&output=HTML&utf8=1&sort=bydistance&orderRatingFirst=0&f_userowner=0&f_userfound=0&f_inactive=0&f_disabled=0&f_ignored=0&f_otherPlatforms=0&f_geokrets=0&country=&language=&difficultymin=0&difficultymax=0&terrainmin=0&terrainmax=0&cachetype=8&cachesize=1%3B2%3B3%3B4%3B5%3B6%3B7%3B8&cache_attribs=&cache_attribs_not=&submit_all=Suchen
# and use "Save options" ("Optionen speichern"). Set a list name and retrieve the
# query ID from
#     https://www.opencaching.de/query.php
# (end of the URL when clicking the list name).
